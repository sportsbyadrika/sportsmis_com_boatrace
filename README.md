...
| **Event Admin** (per event) | Event details, teams (singly or bulk-uploaded from CSV), registrations, the Order of Events with per-race entries and boat photos, Event User accounts — and can open the race office directly, holding every privilege while in there |
